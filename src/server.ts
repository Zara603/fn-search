...
export default function server(): any {
  ...
  app.get(
    "/api/search/geo-search",
    geoSearchController.index
  );

  app.get(
    "/api/search/location-search",
    locationSearchController.index
  );

  app.get(
    "/api/search/holiday-type-search",
    holidayTypeSearchController.index
  );

  app.get(
    "/api/search/index-offers",
